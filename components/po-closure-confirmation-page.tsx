...
interface POClosureConfirmationPageProps {
  poId: string
  onBack: () => void
  onSuccess?: () => void
}
...
export default function POClosureConfirmationPage({ poId, onBack, onSuccess }: POClosureConfirmationPageProps) {
  ...
  const [collapsedSupporting, setCollapsedSupporting] = useState(false)
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F7F8FA]">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <div
          className={`bg-white rounded-lg flex-shrink-0 h-full overflow-hidden flex flex-col ml-4 mt-4 mb-4 transition-all duration-300 ${
        ...
        {/* Main content */}
        <div className="flex-1 flex flex-col h-full overflow-hidden ml-4 mt-4 mr-4 mb-4">
          <div
            ref={contentRef}
                      ...
                      <div key={milestone.id} className="space-y-4">
                        <div className="grid grid-cols-3 gap-6">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-900">{milestone.scheduleDate}</p>
                          </div>
                        </div>
                        <div className="grid grid-cols-2 gap-6">
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Amount</label>
                            <p className="text-sm text-gray-900">{milestone.amount}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Value (%)</label>
                            <p className="text-sm text-gray-900">{milestone.value}</p>
                          </div>
                        </div>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm font-medium text-[#1B733D]">Purchase order</span>
                              </div>
                              <span className="text-sm text-gray-600">Purchase order.PDF</span>
                            </div>
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                              <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-red-500 rounded flex items-center justify-center flex-shrink-0">
                                ...
                                <span className="text-sm font-medium text-[#1B733D]">AMC agreement</span>
                              </div>
                              <span className="text-sm text-gray-600">AMC agreement.PDF</span>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                {!collapsedSections["supplier-submissions"] && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-gray-900 mb-2">Submitted on</h4>
                      ...
                      <div className="mb-6">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            <button className="flex items-center gap-2 px-3 py-1.5 border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                              <Download size={16} />
                            ...
                            >
                              <i
                                className={`ri-arrow-${collapsedEvidence ? "down" : "up"}-s-line text-lg text-gray-600`}
                              ></i>
                            </button>
                          </div>
                        </div>
                            ...
                            <table className="w-full">
                              ...
                              <tbody>
                                <tr className="border-b border-gray-200 hover:bg-gray-50">
                                  <td className="px-4 py-3">
                                    <div className="flex items-center gap-3">
                                      <div className="w-8 h-8 bg-red-500 rounded flex items-center justify-center flex-shrink-0">
                                        <i className="ri-file-pdf-line text-white text-sm"></i>
                                      </div>
                                      <div>
                                  ...
                                  <td className="px-4 py-3 text-right text-sm text-gray-900">02-Aug-2022</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => setCollapsedSupporting(!collapsedSupporting)}
                              className="p-1 hover:bg-gray-100 rounded transition-colors"
                            >
                              <i
                                className={`ri-arrow-${collapsedSupporting ? "down" : "up"}-s-line text-lg text-gray-600`}
                              ></i>
                            </button>
                          </div>
                        </div>
