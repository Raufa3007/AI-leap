    ...
    <tbody className="divide-y divide-gray-200">
      {invoiceData.map((item) => {
        ...
        const isSelected = selectedInvoice?.invoiceRef === item.invoiceRef;
            ...
            <td className="truncate px-6 py-4 text-sm font-semibold text-gray-900">
              {item.invoiceNumber}
            </td>

            <td className="truncate px-6 py-4 text-sm text-gray-900">
              {item.invoiceDate}
            </td>

            <td className="truncate px-6 py-4 text-sm text-gray-900" title={item.vendorName}>
              {item.vendorName}
            </td>
            ...
            <td className="truncate px-6 py-4 text-sm text-gray-900" title={item.purchaseOrderVendorName}>
