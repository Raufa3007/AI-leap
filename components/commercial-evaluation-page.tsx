                            ...
                            <div className="col-span-3">
                              ...
                              {result ? (
                                ...
                                <button
                                  ...
                                  className="px-4 py-2 rounded-lg font-bold text-sm text-gray-900 hover:ring-2 hover:ring-green-300 transition"
                                >
                                  {
                                    result.overallScore
                                  }
                ...
                <table className="w-full table-fixed border-collapse">
                  ...
                  <thead className="sticky top-0 z-10">
                    ...
                    <tr className="bg-[#1B733D] text-white">
                      ...
                      <th className="px-4 py-4 text-center w-[8%] border-r-2 border-white/30 bg-[#1B733D]">
                        Weight
                      </th>
                                  ...
                                  >
                                    ...
                                    null ? (
                                      ...
                                      <button
                                        ...
                                        className="inline-flex items-center justify-center min-w-[75px] px-3 py-2 rounded-lg font-bold text-sm text-gray-900 transition hover:scale-105 cursor-pointer"
                                      >
                                        {
                                          score
                                        }
