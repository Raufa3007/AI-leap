...
import InvoiceApprovalDecisionDialog from "./invoice-approval-decision-dialog"

interface ProcReviewInvoicePageProps {
  poId: string
  onBack: () => void
  onViewInvoiceApp: () => void
  onInvoiceReviewed?: () => void
}

export default function ProcReviewInvoicePage({
  poId,
  onBack,
  onViewInvoiceApp,
  onInvoiceReviewed,
}: ProcReviewInvoicePageProps) {
  ...
  const handleDecisionComplete = (decision: string, comments?: string) => {
    console.log("[v0] Invoice decision:", decision, comments)
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <h2 className="text-2xl font-bold" style={{ color: "#1B733D" }}>
            Review & approve invoice of item in PO#3432
          </h2>
        </div>
        <div className="flex items-center gap-3">
