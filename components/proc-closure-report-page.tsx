...
import { RiMessage2Line, RiHistoryLine, RiFileList3Line, RiFileCheckLine, RiArrowRightLine } from "react-icons/ri"
import ClosureReportDecisionDialog from "./closure-report-decision-dialog"

interface ProcClosureReportPageProps {
  poId: string
  onBack: () => void
  onViewClosureReport: () => void
  onClosureReportCompleted?: () => void
}

export default function ProcClosureReportPage({
  poId,
  onBack,
  onViewClosureReport,
  onClosureReportCompleted,
}: ProcClosureReportPageProps) {
  const [showClosureDecisionDialog, setShowClosureDecisionDialog] = useState(false)

  const handleDecide = () => {
    setShowClosureDecisionDialog(true)
  }

  const handleClosureComplete = () => {
    console.log("[v0] Closure report completed, triggering onClosureReportCompleted callback")
    onClosureReportCompleted?.()
  }
  ...
  return (
    <>
      <div className="min-h-screen p-8 overflow-y-auto" style={{ backgroundColor: "#F7F8FA" }}>
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold" style={{ color: "#1B733D" }}>
              Prepare closure report for PO #{poId}
            </h2>
          </div>
          <div className="flex items-center gap-3">
            <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <RiMessage2Line className="text-xl text-gray-600" />
            </button>
            <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <RiHistoryLine className="text-xl text-gray-600" />
            </button>
            <Button
              variant="outline"
              className="px-6 py-2 text-white rounded-lg font-medium hover:opacity-90 transition-colors bg-transparent"
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="flex-1 pr-6">
                ...
                <button className="text-sm font-normal flex items-center gap-1" style={{ color: "#45546E" }}>
                  View More <RiArrowRightLine className="text-base" />
                </button>
              </div>
            </div>
            ...
            <div
              className="flex items-center gap-4 p-0 bg-white rounded-lg overflow-hidden cursor-pointer hover:shadow-lg transition-shadow"
              style={{ boxShadow: "0px 0px 8px rgba(0, 0, 0, 0.12)", height: "72px" }}
              onClick={onViewClosureReport}
            >
              <div
                className="flex items-center justify-center flex-shrink-0"
                style={{ backgroundColor: "#F7F8FA", width: "72px", height: "72px", padding: "24px" }}
              >
                <RiFileCheckLine className="text-2xl" style={{ color: "#1B733D" }} />
              </div>
              <div className="flex-1 pr-6">
                <p className="text-sm font-medium mb-2" style={{ color: "#000525" }}>
                  Closure report
        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg p-6" style={{ boxShadow: "0px 0px 8px rgba(0, 0, 0, 0.12)" }}>
            <h5 className="text-base font-medium mb-4" style={{ color: "#000525" }}>
              Leadership Development Training Program- 1000000107
            </h5>
            <div className="grid grid-cols-4 gap-6">
              <div>
                <p className="text-xs font-normal mb-2" style={{ color: "#5F6C81" }}>
        ...
        <div className="bg-white rounded-lg p-6" style={{ boxShadow: "0px 0px 8px rgba(0, 0, 0, 0.12)" }}>
          <div className="flex items-center justify-between mb-6">
            <h4 className="text-base font-semibold text-gray-900">Recent Invoice snapshot</h4>
          ...
          <div className="space-y-4 mb-6">
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">019401849713</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 mb-1">Date issued</p>
                <p className="text-sm font-medium text-gray-900">23 Oct 2025</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 mb-1">Due date</p>
                <p className="text-sm font-medium text-gray-900">22 Nov 2025</p>
              </div>
            </div>

            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm font-medium text-gray-900 mb-2">Billed to:</p>
              <p className="text-sm text-gray-600">KaapSarc</p>
              <p className="text-sm text-gray-600">123 Market Street</p>
              <p className="text-sm text-gray-600">San Francisco, CA 94105</p>
            </div>

            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm font-medium text-gray-900 mb-2">From:</p>
              <p className="text-sm text-gray-600">Kaar Technologies</p>
              <p className="text-sm text-gray-600">Shyamala Towers, 8th Floor</p>
              <p className="text-sm text-gray-600">Chennai, Tamilnadu, 600015</p>
            </div>
          </div>
            ...
            <table className="w-full">
              <thead>
                <tr style={{ backgroundColor: "#1B733D" }}>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-bold text-white">Quantity</th>
                  <th className="px-4 py-3 text-left text-sm font-bold text-white">Unit Price (SAR)</th>
                  <th className="px-4 py-3 text-left text-sm font-bold text-white">Total price (SAR)</th>
                </tr>
              </thead>
              <tbody className="bg-white">
                <tr className="border-b border-gray-200">
                ...
                <tr>
                  <td className="px-4 py-3 text-sm font-semibold" style={{ color: "#000525" }} colSpan={3}>
                    Total
                  </td>
                  <td className="px-4 py-3 text-sm font-semibold" style={{ color: "#000525" }}>
                    6,500
          ...
          <div className="space-y-2 text-sm pt-4 border-t border-gray-200">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-900">Axis bank</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Account number</span>
              <span className="font-medium text-gray-900">AX123000000123456567</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Swift code</span>
              <span className="font-medium text-gray-900">AXIX3552</span>
            </div>
          </div>
      ...
      <ClosureReportDecisionDialog
        isOpen={showClosureDecisionDialog}
        onClose={() => setShowClosureDecisionDialog(false)}
