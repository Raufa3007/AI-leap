...
interface COCDecisionDialogProps {
  onComplete?: () => void
  onCancel?: () => void
}

export default function COCDecisionDialog({ onComplete, onCancel }: COCDecisionDialogProps) {
            ...
            <div className="flex flex-col items-start gap-10 flex-1 ml-4">
              ...
              <div className="flex flex-col items-start gap-1">
                <div className="flex flex-row justify-center items-center px-[10px]">
                  <h3 className="text-white text-xl font-medium">Vendor invoice and payment process</h3>
                </div>
                <div className="flex flex-row items-center px-[10px]">
                  <p className="text-white opacity-60 tracking-[0.02em] text-sm leading-relaxed">
                    The procurement team and requester will be notified that all items or services have been received.
                    The vendor invoice and payment process can begin
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-start gap-1">
                <div className="flex flex-row justify-center items-center px-[10px]">
                  <h3 className="text-white text-xl font-medium">Invoice matching and verification</h3>
                </div>
                <div className="flex flex-row justify-center items-center px-[10px]">
                  <p className="text-white opacity-50 tracking-[0.02em] text-sm leading-relaxed">
                    The invoice matching and payment process will proceed automatically through Accounts Payable. The
                    supplier will be notified of successful delivery confirmation.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col justify-center items-center p-10 gap-8 bg-white rounded-[11px] w-[573px] relative z-10">
          ...
          <div className="flex flex-col items-start gap-4 w-full px-8">
            ...
            <div
              ...
              style={{ borderColor: selectedOption === "approve" ? "#000525" : "#000000" }}
            ...
            >
              ...
              <div className="flex flex-row items-center w-full gap-3">
                ...
                <div className="flex flex-row items-center justify-center p-1 w-[18px] h-[18px] border border-black rounded-full cursor-pointer">
                  {selectedOption === "approve" && <div className="w-[10px] h-[10px] bg-black rounded-full" />}
                </div>
              ...
              <div className="flex flex-row justify-center items-center py-[6px] px-[10px] ml-7">
                <p className="text-[#000525] opacity-50 tracking-[0.01em] text-sm">
                  System will generate completion certificate
                </p>
              </div>
            </div>

            {/* Radio Option 2 - Reject */}
            <div
              className="flex flex-col items-start p-4 px-5 w-full bg-white border rounded-md cursor-pointer transition-colors hover:border-gray-400"
            ...
            >
              ...
              <div className="flex flex-row items-center w-full gap-3">
                {/* Radio Button */}
                <div className="flex flex-row items-center justify-center p-1 w-[18px] h-[18px] border border-black rounded-full cursor-pointer">
                  {selectedOption === "reject" && <div className="w-[10px] h-[10px] bg-black rounded-full" />}
                </div>
              ...
              <div className="flex flex-row justify-center items-center py-[6px] px-[10px] ml-7">
                <p className="text-[#000525] opacity-50 tracking-[0.01em] text-sm">
                  The task will remain open for pending deliveries or clarifications.
                </p>
              </div>
            </div>

            {/* Radio Option 3 - Proceed to text task */}
            <div
              className="flex flex-col items-start p-4 px-5 w-full bg-white border rounded-md cursor-pointer transition-colors hover:border-gray-400"
            ...
            >
              ...
              <div className="flex flex-row items-center w-full gap-3">
                {/* Radio Button */}
                <div className="flex flex-row items-center justify-center p-1 w-[18px] h-[18px] border border-black rounded-full cursor-pointer">
                  {selectedOption === "proceed" && <div className="w-[10px] h-[10px] bg-black rounded-full" />}
                </div>

                {/* Label */}
                <div className="flex flex-row justify-center items-center px-[10px]">
                  <span className="tracking-[0.01em] text-black font-medium">Proceed to text task</span>
                </div>
              </div>

              {/* Description */}
              <div className="flex flex-row justify-center items-center py-[6px] px-[10px] ml-7">
                <p className="text-[#000525] opacity-50 tracking-[0.01em] text-sm">This just for Demo</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-start gap-2 w-full px-8">
            <label className="text-sm text-[#000525]">
            ...
            <textarea
              ...
              className="w-full p-3 border border-gray-300 rounded-md text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[#1B733D] focus:border-transparent"
              rows={4}
              disabled={selectedOption !== "reject"}
            />
          </div>
          ...
          <div className="flex flex-row items-center gap-[10px] w-full px-8">
            ...
            <button
              ...
              disabled={!selectedOption || (selectedOption === "reject" && !comments.trim())}
